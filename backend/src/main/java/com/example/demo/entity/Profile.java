...
public class Profile {
    ...
    public java.time.LocalDate getIncorporation_date() { return incorporation_date; }
    public void setIncorporation_date(java.time.LocalDate incorporation_date) { this.incorporation_date = incorporation_date; }
